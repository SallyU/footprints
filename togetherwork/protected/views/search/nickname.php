...
<!-- 右边开始 -->
	...
	<div class="article"><div style="color:#89cd46;font-size:16px;">搜索关键字为&nbsp;&nbsp;<span style="color:red;font-size:18px;">“<?php echo $id; ?>”</span>&nbsp;&nbsp;的昵称：</div>
		<div class="menu">
		    <a href="<?php echo Yii::app()->createUrl('search/index',array('keywords'=>$id)); ?>">标签</a>
		    <a class="on" href="<?php echo Yii::app()->createUrl('search/nickname',array('keywords'=>$id)); ?>">昵称</a>
