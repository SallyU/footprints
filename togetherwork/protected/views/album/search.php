  ...
  <?php if(!Yii::app()->user->getIsGuest()){ ?>
    ...
    <div class="pin wfc" style="position: absolute; left: 0px; top: 0px;">
      <div id="Profile">
        ...
        <div class="unit">
          <div id="task_start_tip">标签为：<a>“<?php echo $cate->cate_name; ?>”</a>&nbsp;的美图！
            <div class="cls"></div>
          </div>
        </div>
    ...
    <?php if($tj ===0){?><div style="width:600px !important;">暂时没有关于<a>“<?php echo $cate->cate_name; ?>”</a>&nbsp;的美图，要不赶快<a href="<?php echo Yii::app()->createUrl('album/upload'); ?>" style="padding-left:15px;">“分享”</a>&nbsp;一张吧~~！！</div><?php }else{?>
